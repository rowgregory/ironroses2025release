...
const APP = {
  name: "iron-roses",
  enterLabel: "iron roses",
  bubble: "hi — i built the iron roses.",
  log: [
    "wiring the content management system .. OK",
    "building the tour date manager ........ OK",
    "wiring the rosebud fan access ......... OK",
    "shipping the site live toggle ......... OK",
  ],
};
...
export default function SqyshSplash() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-dark px-4 py-10">
      <div className="w-full max-w-xl">
        ...
        <motion.div {...pop(T.bubble)} className="mt-2 flex justify-center">
          <div className="relative border border-border-dark px-5 py-3">
            <span
              aria-hidden
              className="absolute -top-[7px] left-1/2 h-3 w-3 -translate-x-1/2 rotate-45 border-l border-t border-border-dark bg-bg-dark"
            />
        ...
        <div className="mx-auto mt-8 w-fit">
          <TypedLine
            delay={T.cmd}
            duration={T.cmdDur}
            className="font-mono text-sm text-text-dark"
          >
            ...
            {APP.log.map((l, i) => {
              ...
              return (
                ...
                >
                  {"> "}
                  {label}{" "}
                  <span className="font-bold text-primary-dark">{status}</span>
                </TypedLine>
              );
            })}
          </div>

...
export const SqyshMascot = ({
  ...
  return (
    ...
    >
      ...
      <svg
        ref={svgRef}
        className={`sq-mascot ${booped ? "booped" : ""} filter-[drop-shadow(0_0_6px_rgba(232,121,249,0.55))_drop-shadow(0_0_16px_rgba(167,139,250,0.4))]`}
        width={size}
        height={size * 1.08}
        viewBox="0 0 240 258"
        aria-hidden="true"
      >
        <defs>
          <linearGradient
            ...
            spreadMethod="repeat"
          >
            <stop offset="0" className="[stop-color:#e879f9]" />
            <stop offset="0.5" className="[stop-color:#a78bfa]" />
            <stop offset="1" className="[stop-color:#e879f9]" />
            <animateTransform
